...
const TermsAndCondition = ({ closeTermsAndCondition }) => {
	return (
		<div className='modal-container'>
			<div className='overlay-style' onClick={closeTermsAndCondition} />
			<div className='modal-style'>
				...
				<div className='modal-text'>
					<div className='modal-text-title'>
						<h3>Welcome to Waray-Waray Dictionary Portal!</h3>
					</div>
					<div className='modal-text-content'>
						{/* <p style={{ textAlign: "center" }}>
							Welcome to Waray-Waray Dictionary Portal!
						</p> */}

						<p>
							By accessing this website we assume you accept these terms
							and conditions. Do not continue to use Waray-Waray
							Dictionary Portal if you do not agree to take all of the
						...
						<p>
							We employ the use of cookies. By accessing Waray-Waray
							Dictionary Portal, you agreed to use cookies in agreement
							with the Waray-Waray Dictionary Portal's Privacy Policy.{" "}
						</p>
						...
						<p>
							Unless otherwise stated, Waray-Waray Dictionary Portal
							and/or its licensors own the intellectual property rights
							for all material on Waray-Waray Dictionary Portal. All
							intellectual property rights are reserved. You may access
							this from Waray-Waray Dictionary Portal for your own
						...
						<ul>
							<li>
								Republish material from Waray-Waray Dictionary Portal
							</li>
							<li>
								Sell, rent or sub-license material from Waray-Waray
								Dictionary Portal
							</li>
							<li>
								Reproduce, duplicate or copy material from Waray-Waray
								Dictionary Portal
							</li>
							<li>
								Redistribute content from Waray-Waray Dictionary Portal
							</li>
						</ul>
						...
						<p>
							...
							of the website. Waray-Waray Dictionary Portal does not
							filter, edit, publish or review Comments prior to their
							presence on the website. Comments do not reflect the views
							and opinions of Waray-Waray Dictionary Portal,its agents
							and/or affiliates. Comments reflect the views and opinions
							of the person who post their views and opinions. To the
							extent permitted by applicable laws, Waray-Waray Dictionary
							Portal shall not be liable for the Comments or for any
						...
						<p>
							Waray-Waray Dictionary Portal reserves the right to monitor
						...
						<p>
							You hereby grant Waray-Waray Dictionary Portal a
						...
						<p>
							...
							hyperlink compensates the absence of Waray-Waray Dictionary
							Portal; and (d) the link is in the context of general
						...
						<p>
							...
							must inform us by sending an e-mail to Waray-Waray
							Dictionary Portal. Please include your name, your
							organization name, contact information as well as the URL
							of your site, a list of any URLs from which you intend to
							link to our Website, and a list of the URLs on our site to
						...
						<p>
							No use of Waray-Waray Dictionary Portal's logo or other
